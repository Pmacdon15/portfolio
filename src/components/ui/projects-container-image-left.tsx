...
export default function ProjectContainerLeft({ title, text, imagePath, gitHubUrl, linkText, website }: { title: string, text: string, imagePath: string, gitHubUrl: string, linkText: string, website?:string }) {
    return (
