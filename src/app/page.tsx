...
export default function Home() {
  return (
    <>
      ...
      <div className='bg-cyan-300 w-full md:w-5/6  rounded-md shadow-xl p-2'>
        <div className="flex flex-col md:flex-row gap-2 rounded-md p-4 bg-[url('/paper.jpeg')] bg-cover">
          ...
          <p className="flex flex-col indent-4  text-lg md:text-xl text-center  justify-center items-center">
            With over 13 years of experience behind the wheel, I've established a versatile and accomplished
            career as a commercial driver. My expertise spans a broad range of vehicles, including tow trucks,
            luxury limousines, party buses, and specialized equipment like crane trucks. Additionally, I've
      ...
      <div className='bg-cyan-300 w-full md:w-5/6  rounded-md shadow-xl p-2'>
        <div className="flex flex-col md:flex-row gap-2 rounded-md p-4 bg-[url('/paper.jpeg')] bg-cover">
          <p className="flex flex-col indent-4  text-lg md:text-xl text-center  justify-center items-center">
            I've made the exciting decision to switch careers and pursue software development.
            Currently enrolled at Bow Valley College, I'm acquiring the skills and knowledge
            necessary to succeed in this dynamic field. I'm eager to apply my strong work ethic and problem-solving
      ...
      <div className='bg-cyan-300 w-full md:w-5/6  rounded-md shadow-xl p-2'>
        <div className="flex flex-col md:flex-row gap-2 rounded-md p-4 bg-[url('/paper.jpeg')] bg-cover">
          <p className="flex flex-col indent-4  text-lg md:text-xl text-center  justify-center items-center">
            I'm a passionate software developer with a specialty in building high-performance applications using
            Next.js and TypeScript. With a strong foundation in modern web development, I'm excited to bring my skills
            to innovative projects. Currently, I'm exploring the capabilities of Vercel for seamless hosting and deployment.
            I'm now seeking opportunities in the software industry where I can leverage my expertise to drive impactful solutions,
